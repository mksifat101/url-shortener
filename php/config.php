<?php 
    ...
    $domain = "https://multi-service.xyz/url_shortener/"; //like this: codingnepalweb.com/
    $host = "localhost";
    $user = "multiser_urls"; //Database username
    $pass = "&1CyTBVw2R6+"; //Database password
    $db = "multiser_urls"; //Database name
